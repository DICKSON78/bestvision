...
const ItemsNotDispensed = () => {
  ...
  useEffect(() => {
    document.title = `Items Not Dispensed Report - ${window.APP_NAME}`;
  }, []);
  ...
  return (
    ...
    >
      <Report
        title={`Items Not Dispensed Report - ${getReportPeriodTitle()}`}
...
export default ItemsNotDispensed;
