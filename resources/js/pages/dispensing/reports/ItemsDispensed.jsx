...
const ItemsDispensed = () => {
  ...
  useEffect(() => {
    document.title = `Items Dispensed Report - ${window.APP_NAME}`;
  }, []);
  ...
  return (
    ...
    >
      <Report
        title={`Items Dispensed Report - ${getReportPeriodTitle()}`}
