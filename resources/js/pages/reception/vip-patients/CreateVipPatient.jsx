  ...
  useEffect(() => {
    if (data) {
      ...
      if (createdId) {
        ...
        addToast({
          message: data?.data?.error || "VIP registration failed. Please try again.",
          severity: "error",
        });
      }
    }
    ...
    <React.Fragment>
      ...
      <CardContent>
        <Alert severity="info" sx={{ mb: 2 }}>
          <AlertTitle>VIP Patient Registration</AlertTitle>
          VIP patients receive priority treatment and enhanced services throughout their visit.
        </Alert>
